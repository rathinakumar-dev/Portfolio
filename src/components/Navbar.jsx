    ...
    <div className="fixed top-6 left-0 right-0 z-50 flex items-center justify-between px-6 max-w-7xl mx-auto">
      ...
      <div className="bg-white rounded-full p-2 me-2 shadow-lg flex lg:hidden">
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
          ...
          <SheetContent
            side="right"
            className="bg-white w-40 text-center h-70 p-0 rounded-2xl right-5 top-10"
          >
            <div className="flex flex-col">
              ...
              <div className="flex flex-col p-4 space-y-2 mt-6">
                ...
                <div className="pt-2 border-t border-gray-100 mt-2 text-center">
                  ...
                  >
                    <div className="px-3 py-2 rounded-full text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-all duration-200 flex items-center justify-center gap-1.5">
